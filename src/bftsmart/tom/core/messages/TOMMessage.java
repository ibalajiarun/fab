...
public class TOMMessage extends SystemMessage implements Externalizable, Comparable, Cloneable {
	...
	public transient long acceptSentTime = 0; //time the replica' write message is sent
	public transient long commitProofSentTime = 0; //time the replica' accept message is sent
