...
public class MessageFactory{
    ...
    public static final int ACCEPT = 44782;
    public static final int COMMITPROOF = 44783;
    ...
    /**
     * Creates a ACCEPT message to be sent by this process
     * @param id Consensus's execution ID
     * @param epoch Epoch number
     ...
     * @return A consensus message of the COMMITPROOF type, with the specified id, epoch, and value
     */
    public ConsensusMessage createCommitProof(int id, int epoch, byte[] value) {

        return new ConsensusMessage(COMMITPROOF,id,epoch, from, value);
